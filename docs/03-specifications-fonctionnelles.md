...
| **Version** | 15 (ajout de `ai_provider_conditions_acquittees` à `client_config`, gap trouvé en construisant le routeur IA §4.4) |
| **Statut** | En rédaction |
