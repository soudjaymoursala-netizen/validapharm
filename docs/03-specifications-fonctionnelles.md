...
| **Version** | 16 (ajout de l'entité `ai_chat_session_log`, gap trouvé en construisant le panneau Chat expert §4.4) |
| **Statut** | En rédaction |
