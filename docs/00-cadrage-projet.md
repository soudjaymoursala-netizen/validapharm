...
- Synchronisation : appel API Drive (miroir, pas source de vérité) après chaque session ou action manuelle — même contrainte "aucune installation", cohérent avec le connecteur Git.
