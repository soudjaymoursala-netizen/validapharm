...
- **Clos le 07/09/2026** : le relais IA de production a désormais son code dans ce dépôt (`workers/ia-relay/`, voir §10quater) — écart retiré de cette liste. Reste néanmoins non déployé côté Cloudflare/Anthropic réel (à la charge de l'utilisateur, voir `workers/ia-relay/README.md`).
