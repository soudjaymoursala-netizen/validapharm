...
| 14 à 17 (Context/Reasoning/UX/Mission workspace) | Non engagées — plan tranché, code non commencé | — | `docs/convergence/CONVERGENCE_PLAN.md` (sections dédiées ci-dessus) |
