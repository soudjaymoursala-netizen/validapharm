...
| 21 (Template Intelligence généralisée — génération `docxtemplater`, ingestion Excel) | Non engagée — chantier P0 suivant du plan Vision North Star, voir `VISION_NORTH_STAR_CONVERGENCE.md` §4 | — | — |
| Extraction automatique de structure procédurale (IA-assistée) | **Point ouvert, non engagé** — décision produit à trancher explicitement avec l'utilisateur avant d'être engagé (`PHASE_20_PROCEDURAL_KNOWLEDGE_SPEC.md` §7) | — | — |
