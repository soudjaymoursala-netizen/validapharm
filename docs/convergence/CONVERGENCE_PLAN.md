...
| 21 (Parseur déterministe de structure procédurale) | **Terminée (27/08/2026)** | voir historique git de la branche | `01-URS-outil.md` v49 (§4.26/URS-F-260 à quater), `03-specifications-fonctionnelles.md` v39, `docs/convergence/PHASE_21_PARSEUR_STRUCTURE_PROCEDURE_SPEC.md`, `TECHNICAL_DECISIONS.md` (TD-017) |
| 8b, 9 (Generate/Render/Approve/Freeze), 12 (étapes 2 à ~42) | Non engagées | — | — |
| 22 (Template Intelligence généralisée — génération `docxtemplater`, ingestion Excel) | Non engagée — chantier P0 suivant du plan Vision North Star, voir `VISION_NORTH_STAR_CONVERGENCE.md` §4 | — | — |
| Repli IA-assisté pour la structuration procédurale (documents hors couverture du parseur déterministe) | **Point ouvert, non engagé** — à engager seulement si un cas réel démontre que la couverture déterministe (Phase 21) est insuffisante, jamais par anticipation (`PHASE_21_PARSEUR_STRUCTURE_PROCEDURE_SPEC.md` §7, TD-017) | — | — |
