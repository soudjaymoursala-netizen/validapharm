...
- Volet Could de §4.5: association de documents normatifs propres à l'utilisateur — nécessiterait l'écran générique de bibliothèque de documents de projet, non construit au-delà du besoin ponctuel.
