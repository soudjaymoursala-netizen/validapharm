...
| URS-NF-052 | *(nouveau v07 — auto-challenge)* L'interface DOIT rester réactive (temps de réponse perçu acceptable) jusqu'à un volume de référence à définir en conception (ex. nombre de projets/sections simultanés) — un test de charge correspondant DOIT être spécifié en OQ/PQ de l'outil. | Should |
