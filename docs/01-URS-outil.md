...
### 4.15 Source/Document Intelligence — structuration assistée *(nouveau v34 — Phase 8a de convergence architecturale, 25/08/2026 ; spec `docs/convergence/PHASE_8A_SOURCE_INTELLIGENCE_SPEC.md` ; séquencement TD-004, sous-phase 8b — compréhension de schémas techniques complexes — non engagée ; **réaligné v36** sur `03_DOMAIN_DATA_MODEL.md` après lecture directe du package source, Google Drive reconnecté en cours de session ; **étendu v46**, Phase 19, TD-014)*
