...
| **Version** | 18 (URS-F-240/Journal d'anomalies/Configuration des connecteurs QMS/statut de qualification d'un actif comblés suite à une seconde simulation d'usage réelle du 31/08/2026, §12 ; v17 : Impact Assessment et Computer System Assessment réellement construits, 29/08/2026 ; v16 : rattrapage documentaire Phases 12-34, 28/08/2026) |
| **Statut** | En rédaction |
...
| Dossier vivant d'un actif *(ajouté v05)* | **Écart v17 partiellement comblé v18 (31/08/2026)** : `DossierVivantActif.vue`, agrégation en lecture seule de tout ce qui porte un `assetNodeId`/`asset_node_id` explicite (ACFC, Impact Assessment, CSV Assessment, Risk Assessment/AMDEC, Missions ancrées) + chaîne technique (URS-F-240) + statut de qualification. **Périmètre non couvert, documenté honnêtement à l'écran plutôt que simulé** : aucune section de gabarit de projet (DQ/FAT/SAT/IQ/OQ/PQ…) n'agrégée — le modèle de données actuel ne porte aucun lien direct section↔nœud (seul le lien section↔section existe), contrairement à ce que décrivait la FS §3.9 d'origine. | URS-F-101 à 101septies |
...
## 12. Écarts documentaires connus (ajouté v16 — audit du 28/08/2026, mis à jour v17 — simulation d'usage du 29/08/2026, v18 — corrections des gaps du 31/08/2026)
...
**Écarts qui restent ouverts après ce rattrapage v18** (à ne pas confondre avec "couverts") :
