 ...
 *
 * **Garde-fou non négociable** : ce module ne produit jamais de
 ...
 *
 * **Limite assumée** : le cas du document attendu
 * absent de la section Documents N'EST PAS implémenté dans ce lot —
